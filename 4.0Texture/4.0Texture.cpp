...
int main(int argc, char *argv[])
{
	...
	GLFWwindow* window = glfwCreateWindow(WIDTH, HEIGHT, "4.0 Texture", NULL, NULL);
	...
	int width, height;
	unsigned char* image = SOIL_load_image("./Resources/wall.jpg", &width, &height, 0, SOIL_LOAD_RGB);
	// 下面这条语句少了，显示黑框, Textures are generated with    glTexImage2D();
