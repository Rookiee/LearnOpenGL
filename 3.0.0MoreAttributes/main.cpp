...
int main(int argc, char *argv[])
{
	...
	GLFWwindow *window = glfwCreateWindow(800, 600, "More Attributes", NULL, NULL);
	if (!window){
	...
	if (!success){
		...
		cerr << "ERROR::SHADER::VERTEX::COMPILATION_FAILED: " << infoLog << endl;
	}
	...
	*/
	...
	if (!success){
		...
		cerr << "ERROR::PROGRAM::LINKING_FAILED: " << infoLog << endl;
	}
